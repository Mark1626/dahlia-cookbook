...
# plot
# sc = ax.scatter(dat.x_f, dat.y_f, dat.z_f, s=4, c=dat.x_f, marker='o', cmap=cmap, alpha=1)
sc = ax.scatter(dat.x, dat.y, dat.z, s=4, c=dat.x_f, marker='o', cmap=cmap, alpha=1)
ax.set_xlabel('X')
ax.set_ylabel('Y')
ax.set_zlabel('Z')
